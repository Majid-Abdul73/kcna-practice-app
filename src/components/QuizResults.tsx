...
const QuizResults: React.FC<QuizResultsProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-white dark:bg-gray-800 rounded-lg shadow-lg">
      <h1 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-8">Quiz Results</h1>
      
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 p-8 rounded-lg mb-8">
        <div className="text-center">
          <h2 className="text-2xl font-semibold text-gray-700 dark:text-gray-300 mb-4">Your Score</h2>
          <div className="text-6xl font-bold text-blue-600 dark:text-blue-400 mb-2">
            {results.score}/{results.totalQuestions}
          </div>
          <div className="text-4xl font-semibold text-gray-600 dark:text-gray-400 mb-2">
            {percentage}%
          </div>
          <div className={`text-2xl font-bold mb-2 ${getGradeColor(getGrade(percentage))}`}>
      ...
      {showDetails && (
        <div className="space-y-6">
          <h3 className="text-2xl font-semibold text-gray-800 dark:text-white mb-6">Question by Question Review</h3>
            ...
            return (
              ...
              >
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded border-l-4 border-blue-500">
                  ...
                  <span className="text-blue-700 dark:text-blue-300 ml-2 italic">
